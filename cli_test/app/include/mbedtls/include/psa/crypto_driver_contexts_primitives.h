 ...
 *  [!] NOTE: (very slight) modifications have been carried out to the present file, with respect to the original (slight modifications the preprocessor directives).
 *
